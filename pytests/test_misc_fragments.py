...
def test_list_construct(datafiles, tmp_path):
    ...
    expected_result = [
        {
            "filename": "list-statement.php",
            "lineNumber": 20,
            "allowedTypes": ["FooClass"],
            "allowedClasses": ["FooClass"],
        },
        {
            "filename": "list-statement.php",
            "lineNumber": 24,
        ...
        },
        {
            "filename": "list-statement.php",
            "lineNumber": 28,
            "allowedTypes": ["BarClass"],
            "allowedClasses": ["BarClass"],
        },
        {
            "filename": "list-statement.php",
            "lineNumber": 33,
            "allowedTypes": ["FooClass", "BarClass"],
            "allowedClasses": ["FooClass", "BarClass"],
        },
    ]
...
def test_fugio_inspired_test(datafiles, tmp_path):
    ...
    expected_result = [
        {
            "filename": "fugio_inspired_test.php",
            "lineNumber": 8,
            "allowedTypes": [""],
            "allowedClasses": [],
        }
...
def test_maybe_unserialize_test(datafiles, tmp_path):
    ...
    expected_result = [
        {
            "filename": "maybe_unserialize_test.php",
            "lineNumber": 6,
            "allowedTypes": ["string", ""],
            "allowedClasses": [],
        }
...
def test_recursive_var_use_test(datafiles, tmp_path):
    ...
    expected_result = [
        {
            "filename": "recursive_var_use_test.php",
            "lineNumber": 4,
...
def test_tostring_test(datafiles, tmp_path):
    ...
    expected_result = [
        {
            "filename": "tostring_test.php",
            "lineNumber": 24,
            "allowedTypes": ["string", "mixed", "string", "HasToString", "mixed"],
            "allowedClasses": [],
        }
    ]
