...
def test_include_directive_project(datafiles, tmp_path):
    ...
    expected_result = [
        ...
        {
            "filename": "src/BackwardsToo.php",
            "lineNumber": 9,
            "allowedTypes": [],
            "allowedClasses": ["BackwardsToo", "Backwards"],
        },
        {
            "filename": "src/ConstantIncl.php",
            "lineNumber": 7,
            "allowedTypes": [],
            "allowedClasses": ["Constant"],
        },
    ]
...
def test_include_test_project(datafiles, tmp_path):
    ...
    assert compare_results(expected_result1, results, project_path)
    ...
    expected_result = [
        {
            "filename": "index.php",
            "lineNumber": 19,
            "allowedTypes": ["string", "", "AnotherClass", "MyClass", "MyOtherClass"],
            "allowedClasses": [],
        }
    ]
    assert compare_results(expected_result, results, project_path)
